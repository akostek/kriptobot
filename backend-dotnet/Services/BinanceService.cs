...
namespace KriptoBot.API.Services
{
    public class BinanceService
    {
        ...
        private BinanceRestClient GetClient(string userId)
        {
            ...
            var env = settings.IsTestnet ? Binance.Net.BinanceEnvironment.Testnet : Binance.Net.BinanceEnvironment.Live;
        ...
        public async Task<List<dynamic>> GetWalletBalances(string userId)
        {
            ...
            var balances = result.Data.Balances
                ...
                .Select(b => new { coin = b.Asset, amount = b.Available })
                .ToList<dynamic>();
